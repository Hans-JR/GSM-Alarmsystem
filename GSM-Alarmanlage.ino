...
/*
 ...
 It is based on  https://github.com/hub-stan/Arduino---alarm-control-panel-with-GSM
 
 Modified and compiled by Hans-J. Richter
 Version 1.0, May 1. 2021
 
The motion detector sends continously when output goes HIGH
The two other inputs detect a HIGH going signal. A message is being send each time when the signal goes from LOW to HIGH
